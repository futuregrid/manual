# -*- coding: utf-8 -*-
#
# Cloud Computing Book documentation build configuration file, created by
# sphinx-quickstart on Thu Jun  6 07:32:30 2013.
#
...
project = u'Cloud Computing Book'
...
htmlhelp_basename = 'CloudComputingBookdoc'
...
latex_documents = [
  ('index', 'CloudComputingBook.tex', u'Cloud Computing Book Documentation',
...
man_pages = [
    ('index', 'cloudcomputingbook', u'Cloud Computing Book Documentation',
...
texinfo_documents = [
  ('index', 'CloudComputingBook', u'Cloud Computing Book Documentation',
   u'Gregor von Laszewski', 'CloudComputingBook', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Cloud Computing Book'
